...
class LSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers, pred_output_size, clas_output_size):
        ...
        # self.h0 = nn.Parameter(torch.zeros(self.num_layers, input_size, self.hidden_size))
        # self.c0 = nn.Parameter(torch.zeros(self.num_layers, input_size, self.hidden_size))
        # Activation Function
